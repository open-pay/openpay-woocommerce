...
class Openpay
{
    ...
    public static function setOriginMerchant($classification){
        if ($classification != '') {
            self::$classification = $classification;
        }
    }

    public static function getOriginMerchant(){
    ...
    public static function setEndpointUrl($country){
        if($country == 'MX'){
            ...
            self::$apiEndpoint = 'https://production-api.openpayargentina.com.ar/v1';
            self::$apiSandboxEndpoint = 'https://sandbox-api.openpayargentina.com.ar/v1';
        }
    }
